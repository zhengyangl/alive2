...
; AVX512-NEXT:    vpavgb %xmm1, %xmm0, %xmm0 ## EVEX TO VEX Compression encoding: [0xc5,0xf9,0xe0,0xc1]
; AVX512-NEXT:    ret{{[l|q]}} ## encoding: [0xc3]
  %res = call <16 x i8> @llvm.x86.sse2.pavg.b(<16 x i8> <i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10>, <16 x i8> <i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 12>) ; <<16 x i8>> [#uses=1]
  ret <16 x i8> %res
}
